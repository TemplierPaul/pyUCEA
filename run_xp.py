...
parser.add_argument('--mutation', type=str, default='ga', choices=['ga', 'es'], help='Mutation type')
...
parser.add_argument('--scaling_type', type=str, default="constant", choices=["constant", "best", "last", "scale"], help='Scaling type')
